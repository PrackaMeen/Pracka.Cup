...
namespace Pracka.Cup.Database.Migrations
{
    ...
    [Migration("20201129200355_Teams initial seed")]
    partial class Teamsinitialseed
    {
            ...
            modelBuilder.Entity("Pracka.Cup.Database.Models.TeamModel", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Created = new DateTime(2020, 11, 29, 21, 3, 55, 14, DateTimeKind.Local).AddTicks(6878),
                            Icon = "BOSTON_BRUINS",
                            Modified = new DateTime(2020, 11, 29, 21, 3, 55, 18, DateTimeKind.Local).AddTicks(9413),
                            Name = "Boston"
                        },
                        new
                        {
                            Id = 2,
                            Created = new DateTime(2020, 11, 29, 21, 3, 55, 19, DateTimeKind.Local).AddTicks(468),
                            Icon = "BUFFALO_SABRES",
                            Modified = new DateTime(2020, 11, 29, 21, 3, 55, 19, DateTimeKind.Local).AddTicks(484),
                            Name = "Buffalo"
                        },
                        new
                        {
                            Id = 3,
                            Created = new DateTime(2020, 11, 29, 21, 3, 55, 19, DateTimeKind.Local).AddTicks(502),
                            Icon = "PHILADELPHIA_FLYERS",
                            Modified = new DateTime(2020, 11, 29, 21, 3, 55, 19, DateTimeKind.Local).AddTicks(505),
                            Name = "Philadelpia"
                        });
                });
